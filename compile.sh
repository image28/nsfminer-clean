...
CXX="/usr/bin/c++"
CXXFLAGS="-Ofast -Wall -Wno-unknown-pragmas -Wextra -Wno-error=parentheses -pedantic -fpic -std=c++11 -DNDEBUG"
# -faggressive-loop-optimizations -fira-loop-pressure -Ofast
AR="/usr/bin/ar"
